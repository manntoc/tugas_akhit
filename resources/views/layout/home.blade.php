                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="widget footer-about-us">
                                    <img src="/front/images/gae web.png" alt="" class="logo">
                                    <p class="mb-30">PT. KaftapusSerigalaAsia</p>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    ...
                                    <ul class="list-no-dividers">
                                        <li><a href="/">Akun</a></li>
                                        <li><a href="/cart">Riwayat Pesanan</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                                <div class="widget footer-links">
                                    <h5 class="widget-title bottom-line left-align grey">Rekomendasi</h5>
                                    <ul class="list-no-dividers">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6 copyright sm-text-center">
                                <span>
                                    &copy; 2023 by, <a>KaftapusSerigalaAsia</a>
                                </span>
                            </div>
